...
<p align="center">
  <strong>THIS PROJECT IS NO LONGER OPEN SOURCE. THE SOURCE CODE, ASSETS, BRANDING, AND PROJECT FILES ARE NOT LICENSED FOR COPYING, REUSE, MODIFICATION, REDISTRIBUTION, OR REHOSTING.</strong>
</p>
...
- A multiplayer 3D browser driving arena.
- A quick-play arcade combat game built around drifting, wrecks, powerups, and ring control.
- A public playable game, not an open-source project.
- Built with Node.js, Three.js, and realtime WebSockets.
...
| Score ring | The center ring gives players a reason to fight for control. |
...
<p align="center">
  <img src="./assets/readme/github/02-arena-hud.png" alt="Crash Club gameplay screenshot with HUD, leaderboard, radar, and arena view" width="88%" />
</p>

<p align="center">
  <img src="./assets/readme/github/gulag-duel.gif" alt="Crash Club Gulag gameplay GIF" width="88%" />
</p>
...
The project is made available for public play only. You may play the official game and share official links to it, but you may not copy, modify, redistribute, rehost, reuse, extract, or create derivative works from the source code, assets, branding, screenshots, game logic, or other project materials without prior written permission from flowzygames.
